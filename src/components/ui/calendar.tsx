  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Dropdown: (props) => {
          const { fromDate, fromMonth, fromYear, toDate, toYear, toMonth } =
            useDayPicker();
          ...
          if (props.name == "months") {
              ...
              <Select
                ...
                <SelectContent className="bg-white z-50">
                  {selectItems.map((selectItem, i) => (
                    <SelectItem key= {i} className="px-8" value={selectItem.value}>
                      {selectItem.label}
                    </SelectItem>
                  ))}
                </SelectContent>
            ...
            return (
              <Select
                onValueChange={(nv) => {
                  const newDate = new Date(currentMonth);
                  newDate.setFullYear(parseInt(nv));
                  goToMonth(newDate);
                }}
                value={props.value?.toString()}>
